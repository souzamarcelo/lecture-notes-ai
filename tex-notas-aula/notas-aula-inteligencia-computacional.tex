...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.35\textwidth]{\templatesdir/\template/img/logo-udesc.png}
\end{figure}
}
...
\part{Introdução}
\input{caps/definicao-historico-paradigmas}
\input{caps/agentes-inteligentes}

\part{Resolução de problemas}
\input{caps/buscas}
\input{caps/metaheuristicas}
 
\part{Aprendizagem de máquina}
\input{caps/conceitos-basicos-aprendizagem-maquina}
\input{caps/aprendizado-supervisionado}
\input{caps/aprendizado-nao-supervisionado}
\input{caps/aprendizado-por-reforco}

%\part{Conteúdos adicionais}
%\chapter{Tópicos em sistemas fuzzy}
%\chapter{Tópicos em sistemas especialistas}

\part{Apêndices}
\appendix
\input{caps/resolucao-exercicios}
